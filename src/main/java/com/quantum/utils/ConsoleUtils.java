...
public class ConsoleUtils
{
    ...
    {
        return caps.getCapability("deviceName") == null ? (caps.getCapability(
                "deviceDbName") == null ? (caps.getCapability("description") == null ? "" : caps.getCapability(
                "description") + "") : caps.getCapability("deviceDbName") + "") : caps.getCapability("deviceName") + "";
    }

    public static String getPlatformName(Capabilities caps)
    {
        return caps.getCapability("platformName") == null ? (ConfigurationUtils.isDesktopBrowser(caps) ? ("ANY".equals(
                caps.getCapability("platform")) ? "Desktop" : caps.getCapability(
                "platform") + "") : (caps.getCapability("os") == null ? "Device" : caps.getCapability(
                "os") + "")) : caps.getCapability("platformName") + "";
    }

    public static String getVersion(Capabilities caps)
    {
        return caps.getCapability(
                "platformVersion") == null ? (caps.getVersion() == null || caps.getVersion().isEmpty() ?
                caps.getBrowserName() : caps.getVersion()) : caps.getCapability(
                "platformVersion") + "";
    }
